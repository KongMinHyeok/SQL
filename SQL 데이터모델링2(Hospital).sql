...
GRANT ALL PRIVILEGES ON `java1_md_hospital`.* TO 'root'@'%';
FLUSH PRIVILEGES;
...
insert into `Doctors` values('D101102','계백','1975-06-11','M',101,'전문의','010-1102-1975','geaback@bw.com');
...
insert into `Nurses` values('N102101','이영애','1975-07-11','F',102,'수간호사','010-1101-7507','yung@bw.com');
...
#Patients 환자
insert into `Patients` values('P102101','D102101','N102101','정우성','760121-1234567','M','서울','010-1101-7601', not null,'배우');
insert into `Patients` values('P103101','D103101','N103101','이정재','750611-1234567','M','서울','010-1102-7506',not null,'배우');
...
insert into `Patients` values('P102103','D102104','N102102','유재석','721128-1234567','M','부산','010-6101-7211',not null,'개그맨');
insert into `Patients` values('P107101','D107104','N107101','강호동','920907-1234567','M','부산','010-7103-9209',not null,'개그맨');
